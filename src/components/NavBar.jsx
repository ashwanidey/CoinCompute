        ...
        <div className="hidden md:block m-2 flex flex-col items-center w-[40vh] overflow-hidden text-gray-400 bg-[#040D12] rounded-xl re">
            ...
            <div className="w-[40vh] px-2">
                <div className="flex flex-col items-center w-[40vh] mt-3 border-t border-[#040D12]">
                    <NavLink id="pnl-tag" className="flex items-center w-full h-9 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" to="/pnl">
                    ...
                    <NavLink id="liquidation-price-tag" className="flex items-center w-full h-9 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" to="/liquidationPrice">
                        <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        <span className="ml-2 text-sm font-medium">Liquidation Price</span>
                    </NavLink>
                    <NavLink id="max-open-tag" className="flex items-center w-full h-9 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300" to="/maxOpen">
                        <svg className="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="m-2 md:hidden flex flex-row  items-center md:w-[40vh]  overflow-y-hidden  mb-3 text-gray-400 bg-[#070E13] rounded-full pb-2">
            ...
            <div className="w-full px-2">
                <div className="flex sm:flex-col  flex-row items-center w-full  border-t border-[#040D12]">
                    ...
                    <NavLink id="liquidation-price-tag1" className="flex items-center w-full h-9 px-2 mt-2 rounded-full hover:bg-gray-700 hover:text-gray-300"to="/liquidationPrice" style={{ whiteSpace: 'nowrap' }}>
                        
                        <span className="text-sm font-medium">Liquidation Price</span>
                    </NavLink>
                    <NavLink id="max-open-tag1" className="flex items-center  h-9 px-2 mt-2 rounded-full hover:bg-gray-700 hover:text-gray-300" to="/maxOpen" style={{ whiteSpace: 'nowrap' }}>
